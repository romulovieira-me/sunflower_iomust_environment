...
if __name__ == "__main__":
  ...
  # The IP must be from the multicast address of the local network 
      default="239.255.255.250", help="The ip to listen on") 
  ...
  dispatcher.map("/connected", print, "Hello") # prints 'Hello' to the terminal 
  dispatcher.map("/disconnected", print, "Goodbye")
