...
inspired and adapted from the example code of the python-osc library, available at: https://pypi.org/project/python-osc/

The code sends a Pure Data message in OSC format to the multicast address of the local network.

The main goal of this code is to verify when the patch connects to the network and when it disconnects
...
if __name__ == "__main__":
  ...
  dispatcher.map("/hello/*", print) # print Pure Data messages on terminal  - O * permite ler o endereço completo, sem necessidade de especifica-lo
